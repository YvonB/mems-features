<!DOCTYPE html>
			...
			<head>
				<meta charset="UTF-8">
				<title>SDPE - IoT Nh3 Historics one hours ago</title>
			...
			<div class="container"> <!-- contenu de la page -->
			            ...
			            <div class="row">
			                <div class="col-md-8" id="results">
			                    <h2>Quantité de NH3 émis il y a <?php echo $_POST['aujourduiHeurNh3'].' h';?></h2>
...
if(is_numeric($_POST['aujourduiHeurNh3']))
{ 
	// compris entre 1 et 23
	if($_POST['aujourduiHeurNh3']>=1 AND $_POST['aujourduiHeurNh3']<24)
	{
		?>
			    			...
			    			foreach ($arr_posts as $obj_post) 
						            ...
						            if ($int_date_diff < (3600 * 24)) 
						                {
						                    ...
						                    if($_POST['aujourduiHeurNh3'] == $str_date_display)
						                    {
							    ...
							    // On n'a pas trouvé aucune correspondance
							          if (!$exist) {
										...
										<a href="/zone_2/home/nh3"><button class="btn btn-primary retourBtn" style="margin-top: 15px"><i class="fa fa-arrow-left" aria-hidden="true" style="margin-right: 4px"></i>
										Retour</button></a>	
									</div> <!-- end col md 8 -->
								</div> <!-- end row -->
								</div> <!-- end container -->
			...
			?>
						...
						<a href="/zone_2/home/nh3"><button class="btn btn-primary retourBtn"><i class="fa fa-arrow-left" aria-hidden="true" style="margin-right: 4px"></i>
						Retour</button></a>	
					</div> <!-- end col md 8 -->
				</div> <!-- end row -->
				</div> <!-- end container -->
