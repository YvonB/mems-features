...
<head>
	<meta charset="UTF-8">
	<title>SDPE - IoT Yersterday Nh3 Historics</title>
...
<div class="container"> <!-- contenu de la page -->
	<div class="row">
					<div class="col-md-8" id="results">
				    	<h2>Liste(s) Quantité de NH3 émis hier</h2>
...
<a href="/zone_2/home/nh3"><button class="btn btn-primary retourBtn"><i class="fa fa-arrow-left" aria-hidden="true" style="margin-right: 4px"></i>Retour</button></a>	
</div> <!-- end col md 8  -->
</div> <!-- end row -->
</div> <!-- end container -->
...
else
{
	...
	foreach ($arr_posts as $obj_post) 
						...
						?>
							...
							// On affiche les résultats pour le NH3
								...
								if(isset($obj_post->nh3) AND !empty($obj_post->nh3))
									{
										echo '<div class="gas">NH3 = <strong>', htmlspecialchars($obj_post->nh3),'</strong><em>ppm</em>    ', '</div>';
										                        }
										echo '</div>';
										echo "</pre>";
			...
			<a href="/zone_2/home/nh3"><button class="btn btn-primary retourBtn" style="margin-top: 15px"><i class="fa fa-arrow-left" aria-hidden="true" style="margin-right: 4px"></i>Retour</button></a>	
		</div> <!-- end col md 8 -->
	</div> <!-- end row -->
</div> <!-- end container -->
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script>
