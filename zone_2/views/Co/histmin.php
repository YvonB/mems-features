<!DOCTYPE html>
	...
	<head>
		<meta charset="UTF-8">
		<title>SDPE - IoT co Historics some minute ago</title>
	...
	<div class="container"> <!-- contenu de la page -->
				         ...
				         <div class="row">
				             <div class="col-md-8" id="results">
				                 <h2>Liste(s)Quantité de CO émis il y a <em><?php echo $_POST['aujourduiMinCo'].' min';?></em></h2>
...
if(is_numeric($_POST['aujourduiMinCo']))
    {
    	// on verifie que c'est bien entre 0 et 59
    	if($_POST['aujourduiMinCo']>=0 AND $_POST['aujourduiMinCo']<60)
    	{
    		?>	
				...
				try
				{
				    ...
				    if(empty($arr_posts))
				    	{	
				    		...
				    		{
				    			//Apres on selection les valeures de co qui correspondent à la minute saisie
				    			$exist = false;
				    			foreach ($arr_posts as $obj_post) 
					    			{
							            ...
							            if ($int_date_diff < 3600) 
							                {
							                    ...
							                    if($_POST['aujourduiMinCo'] == $str_date_display)
							                    {
							                    	$exist = true;
							          ...
							          if (!$exist) {
										...
										<a href="/zone_2/home/co"><button class="btn btn-primary retourBtn" style="margin-top: 15px"><i class="fa fa-arrow-left" aria-hidden="true" style="margin-right: 4px"></i>
										Retour</button></a>	
									</div> <!-- end col md 8 -->
								</div> <!-- end row -->
								</div> <!-- end container -->
				...
				?>
						...
						<a href="/zone_2/home/co"><button class="btn btn-primary retourBtn"><i class="fa fa-arrow-left" aria-hidden="true" style="margin-right: 4px"></i>
						Retour</button></a>	
					</div> <!-- end col md 8 -->
				</div> <!-- end row -->
				</div> <!-- end container -->
