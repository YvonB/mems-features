<!DOCTYPE html>
							...
							<head>
								<meta charset="UTF-8">
								<title>SDPE - IoT All Co Historics</title>
										...
										<?php
										                ...
										                echo '<div class="post">';
										                    if(isset($obj_post->co) AND !empty($obj_post->co))
										                        {
										                            echo '<div class="gas">CO = <strong>', htmlspecialchars($obj_post->co),'</strong><em> ppm</em>    ', '<span class="time"> Il y a ', $str_date_display, '</span></div>';
										                        }
										                echo '</div>';
										                echo "</pre>";
