              ...
              <ul class="nav navbar-nav navbar-right colortextnav">
                <li class="dropdown colortextnav">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="/zone_2/home/co2" style="text-transform: lowercase;">
                        Voir l'état de CO2</a></li>
                    <li><a href="/zone_2/home/co" style="text-transform: lowercase;">
                        Voir l'état de CO</a></li>
                    <li><a href="/zone_2/home/nh3" style="text-transform: lowercase;">
