...
<head>
	...
	<title>SDPE - IoT Two Days Co Historics</title> 
...
<div class="container"> <!-- contenu de la page -->
	<div class="row">
					<div class="col-md-8" id="results">
				    	<h2>Liste(s) Quantité de CO émis il y a 2 jours</h2>
...
else
{
	...
	foreach ($arr_posts as $obj_post) 
			...
			<a href="/zone_1/home/co"><button class="btn btn-primary retourBtn" style="margin-top: 15px"><i class="fa fa-arrow-left" aria-hidden="true" style="margin-right: 4px"></i>Retour</button></a>	
		</div> <!-- end col md 8 -->
	</div> <!-- end row -->
</div> <!-- end container -->
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script>
