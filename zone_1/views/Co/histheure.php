<!DOCTYPE html>
			...
			<head>
				<meta charset="UTF-8">
				<title>SDPE - IoT Co Historics one hours ago</title>
			...
			<div class="container"> <!-- contenu de la page -->
			            ...
			            <div class="row">
			                <div class="col-md-8" id="results">
			                    <h2>Quantité de CO émis il y a <?php echo $_POST['aujourduiHeurCo'].' h';?></h2>
...
if(is_numeric($_POST['aujourduiHeurCo']))
{ 
	// compris entre 1 et 23
	if($_POST['aujourduiHeurCo']>=1 AND $_POST['aujourduiHeurCo']<24)
	{
		?>
						            ...
						            if ($int_date_diff < (3600 * 24)) 
						                {
						                    ...
						                    if($_POST['aujourduiHeurCo'] == $str_date_display)
						                    {
