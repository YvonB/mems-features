...
<div class="panel panel-default histoco2" style="margin-top: 50px;">
	...
	<fieldset class="col-md-6" style="width: 100%;"><legend>Vos coordonnées</legend>
		...
		<div class="form-group"><label for="email">Email :</label><input class="form-control input_cmd" type="text" id="email" name="email" tabindex="2" value="sdpeiot@cur-vontovorona-180708.appspotmail.com" /></div>
	</fieldset>
